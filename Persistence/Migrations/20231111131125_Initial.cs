        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikesCountAllowed = table.Column<int>(type: "int", nullable: true),
                    LocationViewAllowed = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LikedUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LikeDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Sympathy = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserToVks", x => new { x.UserId, x.VkId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportRoomId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportChatMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupportChatMessages_SupportRooms_SupportRoomId",
                        column: x => x.SupportRoomId,
                        principalTable: "SupportRooms",
                        principalColumn: "Id");
                });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Discriminator", "LikesCountAllowed", "LocationViewAllowed", "Name", "NormalizedName" },
                values: new object[,]
                {
                    { "1", null, "Role", 2147483647, true, "Admin", "ADMIN" },
                    { "2", null, "Role", 2147483647, true, "Moderator", "MODERATOR" },
                    { "3", null, "Role", 20, false, "StandartUser", "STANDARTUSER" },
                    { "4", null, "Role", 40, false, "UserMoreLikes", "USERMORELIKES" },
                    { "5", null, "Role", 50, true, "UserMoreLikesAndMap", "USERMORELIKESANDMAP" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", null, 0, "2cba88c3-4f30-49c6-b362-9515574fa991", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, "Gleb", "Male", null, false, false, "Bober", false, null, null, "ADMIN", null, "546bbea7-7dbb-411f-bda7-75ca1a825f04", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportChatMessages_SupportRoomId",
                table: "SupportChatMessages",
                column: "SupportRoomId");
        }
